...
POLITICAS_MUTABLES: dict[tuple[str, str], PoliticaCapacidad] = {
    ...
    ("POST", "/api/docentes/{id_docente}/actualizaciones"): politica("docente.actualizacion.crear", "Administrador", "Coordinacion_EPG"),
    ("POST", "/api/actualizacion-docente/{token}"): politica("docente.actualizacion.publica", publico=True),
    ("POST", "/api/actualizacion-docente/{token}/documentos"): politica("docente.actualizacion.documento.publico", publico=True),
    ("PUT", "/api/docente-actualizaciones/{referencia}/propuesta"): politica("docente.actualizacion.propuesta.editar", "Administrador", "Coordinacion_EPG"),
    ("PUT", "/api/docente-actualizaciones/{referencia}/revision"): politica("docente.actualizacion.revisar", "Administrador", "Coordinacion_EPG"),
    ("PUT", "/api/docente-actualizacion-documentos/{referencia}/revision"): politica("docente.actualizacion.documento.revisar", "Administrador", "Coordinacion_EPG"),
    ...
    ("POST", "/api/docente-tramites/{referencia}/documentos"): politica("docente.tramite.documento.cargar", "Administrador", "Coordinacion_EPG"),
